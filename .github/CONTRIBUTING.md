...
6. [Submit a pull request](https://github.com/distubejs/yt-dlp/compare) (Make sure you follow the [conventional commit format](https://www.conventionalcommits.org/en/v1.0.0/))
